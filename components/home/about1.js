        ...
        <section id="about" className={`${styles.About} `}>
            <div className="container" data-aos="fade-up">
                <div className="row position-relative">
                    <div className={`col-lg-5  ${styles.AboutImg}`} style={{backgroundImage: `url(/late.jpg)`}} data-aos="fade-left" data-aos-delay="100"/>
                    <div className="col-lg-10">
                        ...
                        <div className={styles.OurStory}>
                            ...
                            <p>
                                Tai Lifestyle Limited is located in Mombasa City, Nkrumah Road, Third Floor, Taiyebi
                                House
                                opposite NSSF
                                Building, Mombasa. The company’s postal address is P.O. Box 89990-80100 Mombasa.
                            </p>
                            <p>
                                Tai’s primary focus is to safety in the management of hazardous waste generated from oil
                                and
                                oil
                                products. Therefore, we are specialists in the collection, transportation and disposal
                                of
                                waste oil and
                            ...
                            <p>In regard to safe and proper management of waste to protect human health and the
                                environment,
                                we at Tai
                                Lifestyle Limited are the right people because we have trained professionals suitable
                                for
                                such tasks.
                            ...
                            <p>Over the recent years, the need for growth and diversity has escalated the expansion of
                                our
                                scope to
                                include; handling, transportation and removal of asbestos. To top it off, we own another
                                disposal site
                                located in Maungu town which is about 30 kilometers from Voi town. The Maungu disposal
                                site
                                is fully
                                operational where the Environmental Impact Assessment has been done and respective
                                disposal
                                license
                                issued.
                            </p>
